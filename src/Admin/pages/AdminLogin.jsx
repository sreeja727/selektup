    ...
    try {
      ...
      if (data.success) {
        if (data.data.role === 'ADMIN') {
          localStorage.setItem('selektup_admin_token', data.data.token)
    ...
    >
      ...
      >
        ...
        <VStack gap={0} mb={6} textAlign="center">
          <Text fontWeight={800} fontSize="xl" color="#0C1222">Admin Login</Text>
          <Text fontSize="sm" color="gray.500">Sign in to the admin panel</Text>
        </VStack>
